...
class Program
{
    static void Main()
    {
        ...
        int[] codepoints = { /* Add your codepoints here */ };
        ...
        Font nameFont = Raylib.LoadFontEx("name_font.ttf", 1000, codepoints, 1382);
        Font descFont = Raylib.LoadFontEx("desc_font.ttf", 1000, codepoints, 1382);
        ...
        string leaderTitle;
        string leaderDescription = "Spuszcza ci klasyczny, \ntradycyjny oruński wpierdol.";
